            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(2), ['dashboard'])){{ 'bg-slate-900' }}@endif" x-data="{ open: {{ in_array(Request::segment(2), ['dashboard']) ? 1 : 0 }} }">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if(in_array(Request::segment(2), ['dashboard'])){{ 'hover:text-slate-200' }}@endif" href="{{ Auth::user()->is_admin == true ? route('dashboard') : route('dashboard-pelamar')}}">
                    ...
                    <!-- User dan Pelamar -->
                    @can('admin')
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(2), ['users', 'pelamar'])){{ 'bg-slate-900' }}@endif" x-data="{ open: {{ in_array(Request::segment(2), ['users', 'pelamar']) ? 1 : 0 }} }">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if(in_array(Request::segment(2), ['users', 'pelamar'])){{ 'hover:text-slate-200' }}@endif" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                ...
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-slate-400 @if(in_array(Request::segment(2), ['users', 'pelamar'])){{ 'rotate-180' }}@endif" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                                        <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                    </svg>
                                </div>
                            </div>
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-9 mt-1 @if(!in_array(Request::segment(2), ['users', 'pelamar'])){{ 'hidden' }}@endif" :class="open ? '!block' : 'hidden'">
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if(Route::is('users.*')){{ '!text-indigo-500' }}@endif" href="{{ route('users.index') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Manajemen User</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if(Route::is('admin.pelamar.*')){{ '!text-indigo-500' }}@endif" href="{{ route('admin.pelamar.index') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Pelamar</span>
                                    </a>
                                </li>
                    ...
                    <!-- penilaian -->
                    @can('admin')
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(2), ['kriteria', 'sub-kriteria', 'pertanyaan', 'penilaian'])){{ 'bg-slate-900' }}@endif" x-data="{ open: {{ in_array(Request::segment(2), ['kriteria', 'sub-kriteria', 'pertanyaan', 'penilaian']) ? 1 : 0 }} }">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if(in_array(Request::segment(2), ['kriteria', 'sub-kriteria', 'pertanyaan', 'penilaian'])){{ 'hover:text-slate-200' }}@endif" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <i class="fa-solid fa-list-check"></i>
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Penilaian</span>
                                </div>
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-slate-400 @if(in_array(Request::segment(2), ['kriteria', 'sub-kriteria', 'pertanyaan', 'penilaian'])){{ 'rotate-180' }}@endif" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                                        <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                    </svg>
                                </div>
                            </div>
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-9 mt-1 @if(!in_array(Request::segment(2), ['kriteria', 'sub-kriteria', 'pertanyaan', 'penilaian'])){{ 'hidden' }}@endif" :class="open ? '!block' : 'hidden'">
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if(Route::is('admin.kriteria.*')){{ '!text-indigo-500' }}@endif" href="{{ route('admin.kriteria.index') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Kriteria</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if(Route::is('admin.sub-kriteria.*')){{ '!text-indigo-500' }}@endif" href="{{ route('admin.sub-kriteria.index') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Subkriteria</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if(Route::is('admin.pertanyaan.*')){{ '!text-indigo-500' }}@endif" href="{{ route('admin.pertanyaan.index') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Pertanyaan</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if(Route::is('admin.penilaian.*')){{ '!text-indigo-500' }}@endif" href="{{ route('admin.penilaian.index') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Penilaian</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <!-- Hasil -->
                    @can('admin')
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(3), ['teori', 'wawancara'])){{ 'bg-slate-900' }}@endif" x-data="{ open: {{ in_array(Request::segment(3), ['teori', 'wawancara']) ? 1 : 0 }} }">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if(in_array(Request::segment(3), ['teori', 'wawancara'])){{ 'hover:text-slate-200' }}@endif" href="#0" @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    <i class="fa-solid fa-square-poll-vertical"></i>
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Hasil</span>
                                </div>
                                <!-- Icon -->
                                <div class="flex shrink-0 ml-2 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                    <svg class="w-3 h-3 shrink-0 ml-1 fill-current text-slate-400 @if(in_array(Request::segment(3), ['teori', 'wawancara'])){{ 'rotate-180' }}@endif" :class="open ? 'rotate-180' : 'rotate-0'" viewBox="0 0 12 12">
                                        <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z" />
                                    </svg>
                                </div>
                            </div>
                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-9 mt-1 @if(!in_array(Request::segment(2), ['tes-teori', 'tes-wawancara'])){{ 'hidden' }}@endif" :class="open ? '!block' : 'hidden'">
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if(Route::is('admin.hasil.teori.*')){{ '!text-indigo-500' }}@endif" href="{{ route('admin.hasil.teori.index') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Tes Teori</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if(Route::is('admin.hasil.wawancara.*')){{ '!text-indigo-500' }}@endif" href="{{ route('admin.hasil.wawancara.index') }}">
                                        <span class="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Tes Wawancara</span>
                                    </a>
                                </li>
                    ...
                    {{-- Perhitungan --}}
                    @can('admin')
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(2), ['perhitungan'])){{ 'bg-slate-900' }}@endif" x-data="{ open: {{ in_array(Request::segment(2), ['perhitungan']) ? 1 : 0 }} }">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if(in_array(Request::segment(2), ['perhitungan'])){{ 'hover:text-slate-200' }}@endif" href="{{ route('admin.perhitungan.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    <i class="fa-solid fa-square-root-variable"></i>
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Perhitungan</span>
                                </div>
                                <!-- Badge -->
                                {{-- <div class="flex flex-shrink-0 ml-2">
                                    <span class="inline-flex items-center justify-center h-5 text-xs font-medium text-white bg-indigo-500 px-2 rounded">4</span>
                    ...
                    {{-- Hasil Akhir --}}
                    @can('admin')
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(2), ['hasil-akhir'])){{ 'bg-slate-900' }}@endif" x-data="{ open: {{ in_array(Request::segment(2), ['hasil-akhir']) ? 1 : 0 }} }">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if(in_array(Request::segment(1), ['messages'])){{ 'hover:text-slate-200' }}@endif" href="{{ route('admin.hasil-akhir.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    <i class="fa-solid fa-chart-simple"></i>
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Hasil Akhir</span>
                                </div>
                                <!-- Badge -->
                                {{-- <div class="flex flex-shrink-0 ml-2">
                                    <span class="inline-flex items-center justify-center h-5 text-xs font-medium text-white bg-indigo-500 px-2 rounded">4</span>
                    ...
                    {{-- Pelamar Section --}}
                    @can('pelamar')
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(2), ['data-diri'])){{ 'bg-slate-900' }}@endif" x-data="{ open: {{ in_array(Request::segment(2), ['data-diri']) ? 1 : 0 }} }">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if(in_array(Request::segment(1), ['messages'])){{ 'hover:text-slate-200' }}@endif" href="{{ route('pelamar.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    <i class="fa-solid fa-user-plus"></i>
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Data Diri</span>
                                </div>
                                <!-- Badge -->
                                {{-- <div class="flex flex-shrink-0 ml-2">
                                    <span class="inline-flex items-center justify-center h-5 text-xs font-medium text-white bg-indigo-500 px-2 rounded">4</span>
                    ...
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(2), ['tes-teori'])){{ 'bg-slate-900' }}@endif" x-data="{ open: {{ in_array(Request::segment(2), ['tes-teori']) ? 1 : 0 }} }">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if(in_array(Request::segment(2), ['tes-teori'])){{ 'hover:text-slate-200' }}@endif" href="{{ route('tes-teori.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    <i class="fa-solid fa-list-check"></i>
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Tes Teori</span>
                                </div>
                            </div>
                        </a>
                    </li>
                    @endcan
                    @can('pelamar')
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(2), ['tes-wawancara'])){{ 'bg-slate-900' }}@endif" x-data="{ open: {{ in_array(Request::segment(2), ['tes-wawancara']) ? 1 : 0 }} }">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if(in_array(Request::segment(2), ['tes-wawancara'])){{ 'hover:text-slate-200' }}@endif" href="{{ route('tes-wawancara.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    <i class="fa-solid fa-clipboard-question"></i>
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Tes Wawancara</span>
                                </div>
                            </div>
                        </a>
                    </li>
                    ...
                    @can('pelamar')
                    <li class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if(in_array(Request::segment(2), ['hasil-akhir'])){{ 'bg-slate-900' }}@endif" x-data="{ open: {{ in_array(Request::segment(2), ['hasil-akhir']) ? 1 : 0 }} }">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if(in_array(Request::segment(2), ['hasil-akhir'])){{ 'hover:text-slate-200' }}@endif" href="{{ route('pelamar.hasil-akhir.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="grow flex items-center">
                                    <i class="fa-solid fa-square-poll-vertical"></i>
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Data Hasil Akhir</span>
                                </div>
                                <!-- Badge -->
                                {{-- <div class="flex flex-shrink-0 ml-2">
                                    <span class="inline-flex items-center justify-center h-5 text-xs font-medium text-white bg-indigo-500 px-2 rounded">4</span>
