<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div class="flex flex-wrap justify-between">
            ...
            <div class="mb-12">
                <a href="{{ route('admin.pertanyaan.create') }}" class="bg-indigo-500 text-white rounded-lg px-4 py-2 shadow-sm text-lg font-semibold transition ease-in-out duration-300 hover:opacity-80">
