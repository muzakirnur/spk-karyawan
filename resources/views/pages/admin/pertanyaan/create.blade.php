            ...
            <div class="px-8 py-8 bg-white rounded-lg shadow-lg">
                ...
                <div class="flex flex-wrap mb-4">
                    ...
                    <div class="mb-4 w-1/2">
                        <input type="text" autofocus class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-blue-400 focus:outline-none focus:transition-shadow" placeholder="Masukkan Jawaban" name="jawaban[A]" value="{{ old('A') }}" required />
                ...
                <div class="flex flex-wrap mb-4">
                    ...
                    <div class="mb-4 w-1/2">
                        <input type="text" autofocus class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-blue-400 focus:outline-none focus:transition-shadow" placeholder="Masukkan Jawaban" name="jawaban[B]" value="{{ old('B') }}" required />
                ...
                <div class="flex flex-wrap mb-4">
                    ...
                    <div class="mb-4 w-1/2">
                        <input type="text" autofocus class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-blue-400 focus:outline-none focus:transition-shadow" placeholder="Masukkan Jawaban" name="jawaban[C]" value="{{ old('C') }}" required />
                ...
                <div class="flex flex-wrap mb-4">
                    ...
                    <div class="mb-4 w-1/2">
                        <input type="text" autofocus class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-blue-400 focus:outline-none focus:transition-shadow" placeholder="Masukkan Jawaban" name="jawaban[D]" value="{{ old('D') }}" required />
