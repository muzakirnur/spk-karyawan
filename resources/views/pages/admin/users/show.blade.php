<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="bg-white px-8 py-12 shadow-lg rounded-lg mb-8 dark:bg-slate-500 dark:text-slate-200">
            ...
            <div class="table-responsive mb-8">
                @if ($pelamar == null)
                    <p>Data Pelamar Belum diinput!</p>
                    @else
                    <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500 dark:text-slate-200">
                        <tbody>
                                <tr class="border">
            ...
            <a href="{{ route('users.index') }}" class="px-4 py-2 bg-slate-500 rounded-lg text-white shadow-sm hover:opacity-80 ease-in-out transition duration-300"><i class="fa-solid fa-chevron-left"></i> Kembali</a>
        </div>
    </div>
</x-app-layout>