<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="px-8 py-8 bg-white rounded-lg shadow-lg">
            <form action="{{ route('admin.sub-criteria.save', Crypt::encrypt($id)) }}" method="POST">
                @csrf
                ...
                <div class="mb-4">
                    <input type="number" autofocus class="focus:shadow-soft-primary-outline text-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 transition-all focus:border-blue-400 focus:outline-none focus:transition-shadow" placeholder="Nilai Kriteria" name="nilai" value="{{ old('nilai') }}" required />
